...
var SeasCalc = (function () {
    ...
    SeasCalc.prototype.postCalc = function () {
        ...
        q += '\t?propertyURI seas:evaluation ?evaluationURI .\n';
        q += '\t?evaluationURI seas:evaluatedValue ?res ;\n';
        q += '\t\tprov:generatedAtTime ?now ;\n';
        q += "\t\tseas:calculation \"" + calc + "\"^^xsd:string ;\n";
        ...
        for (var i in args) {
            ...
            q += '\t\tGRAPH ?g {\n';
            q += "\t\t\t" + args[i].targetPath + " " + args[i].property + "/seas:evaluation\n";
        ...
        q += '\tMINUS {\n';
        q += '\t\tGRAPH ?g {\n';
        q += "\t\t\t" + resource + " " + property + "/seas:evaluation\n";
        ...
        q += "\t\tBIND(URI(CONCAT(\"" + hostURI + "\", \"/Evaluation/\", ?guid)) AS ?evaluationURI)\n";
        q += "\t\t#GET CURRENT TIME\n";
        q += "\t\tBIND(now() AS ?now)\n";
        q += '\t}\n';
        q += '}';
